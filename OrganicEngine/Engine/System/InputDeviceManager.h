...
namespace Engine::System {
	...
	public:
		...
		//スティック
		Math::fVec2	GetLeftStick(int);
		Math::fVec2	GetRightStick(int);

		//タッチ構造体
		typedef struct tTouchState
		{
			Math::fVec2	touchPos[10];
			int			nCntTouch = 0;
		}tTouchState;
		...
		//加速度センサ
		Math::fVec3	GetLeftAccel(Math::fVec3);
		Math::fVec3	GetRightAccel(Math::fVec3);

		//傾きセンサ
		Math::fVec3	GetLeftAngle(Math::fVec3);
		Math::fVec3	GetRightAngle(Math::fVec3);
	...
	namespace InputDevice
	{
		...
		Math::fVec2	GetLeftStick(int);
		Math::fVec2	GetRightStick(int);
		Math::fVec2	GetLeftStick(void);
		Math::fVec2	GetRightStick(void);
		...
		Math::fVec3	GetLeftAccel(Math::fVec3);
		Math::fVec3	GetRightAccel(Math::fVec3);
		Math::fVec3	GetLeftAccel(void);
		Math::fVec3	GetRightAccel(void);

		//傾きセンサ
		Math::fVec3	GetLeftAngle(Math::fVec3);
		Math::fVec3	GetRightAngle(Math::fVec3);
		Math::fVec3	GetLeftAngle(void);
		Math::fVec3	GetRightAngle(void);
