...
#ifdef _X86_
#ifdef _DEBUG
#pragma comment(lib, "Resource/DirectXTex/Win32/Debug/DirectXTex.lib")
#else
#pragma comment(lib, "Resource/DirectXTex/Win32/Release/DirectXTex.lib")
#endif
#else
#ifdef _DEBUG
#pragma comment(lib, "Resource/DirectXTex/x64/Debug/DirectXTex.lib")
#else
#pragma comment(lib, "Resource/DirectXTex/x64/Release/DirectXTex.lib")
#endif
#endif
